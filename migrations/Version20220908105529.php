 ...
 */
final class Version20220908105529 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE partenaire CHANGE partenaire_permission_id partenaire_permission_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE partenaire CHANGE partenaire_permission_id partenaire_permission_id INT NOT NULL');
    }
}
