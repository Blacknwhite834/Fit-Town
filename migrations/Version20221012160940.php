 ...
 */
final class Version20221012160940 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE structure_permission DROP partenaire_permission_id');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE structure_permission ADD partenaire_permission_id INT DEFAULT NULL');
